...
namespace online_Hall_Booking.Migrations
{
    ...
    [Migration("20210506092332_hallappointmentupdated")]
    partial class hallappointmentupdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("online_Hall_Booking.Models.HallAppointment", b =>
                {
                    b.Property<int>("HapId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<double>("Persons")
                        .HasColumnType("float");

                    b.Property<double>("RemaingAmount")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("online_Hall_Booking.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("online_Hall_Booking.Models.Country", b =>
                {
                    b.HasOne("online_Hall_Booking.Models.State", "State")
                        .WithMany()
                        .HasForeignKey("SId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("online_Hall_Booking.Models.Hall", b =>
                {
                    b.HasOne("online_Hall_Booking.Models.City", "City")
                        .WithMany()
                        .HasForeignKey("CId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
